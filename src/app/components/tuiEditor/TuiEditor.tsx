...
import { BoArticleInput } from "../../../types/boArticle.ts";
import { serverApi } from "../../../lib/config.ts";
import  assert  from "assert";
import { Definer } from "../../../lib/Definer.ts";
import { sweetTopSmallSuccessAlert } from "../../../lib/sweetAlert.ts";
        ...
        <Box className="form_row" style={{width: "300px"}}>
          ...
          <FormControl sx={{width: "100%", background: "white"}}>
            ...
            onChange={changeCategoryHandler}
             >
             <MenuItem value="">
                <span>Categoriyani Tannlang</span>
             </MenuItem>
               <MenuItem value={"celebrity"}>Mashhurlar</MenuItem>
               <MenuItem value={"evaluation"}>Resaurant Baho</MenuItem>
