...
import { setBestBoArticles,
setTrendBoArticles, setNewsBoArticles} from "./slice.ts"
import { Dispatch } from '@reduxjs/toolkit';
import { retrieveBestBoArticles, retrieveTrendBoArticles, retrieveNewsBoArticles} from './selector.ts';
